 ...
 * @author Feyyaz
 */
public class Islem_2_Yolla implements Runnable {
    ...
    public Islem_2_Yolla(int satir_sayisi, LinkedBlockingQueue<Integer> matris_2_kuyruk, List<Integer> matris2) {
        this.matris_2_kuyruk_2 = matris_2_kuyruk;
    ...
    public void run() {
        ...
        while (true) {
            try {
                gelen_matris_2_no = matris_2_kuyruk_2.take();
            } catch (InterruptedException ex) {
                Logger.getLogger(Islem_2_Yolla.class.getName()).log(Level.SEVERE, null, ex);
            }
